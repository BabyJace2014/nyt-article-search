$(document).ready(function () {
    $("body").on("click", "#submit-button", function () {
        ...
        var queryUrl = "https://api.nytimes.com/svc/search/v2/articlesearch.json?q=" + keyword /*+"&page=" +articleNumber*/ + "&begin_date=" + startYear + "0101&end_date=" + endYear + "1231&api-key=5f22c86521c340aaad440dea7cbb612f";
